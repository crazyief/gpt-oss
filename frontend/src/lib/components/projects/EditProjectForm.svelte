<script lang="ts">
	/**
	 * EditProjectForm - Form to edit an existing project
	 */
	import { createEventDispatcher } from 'svelte';
	import ColorPicker from './ColorPicker.svelte';
	import IconPicker from './IconPicker.svelte';
	import { projects } from '$lib/stores/projects';
	import { updateProject } from '$lib/services/api/projects';
	...
	let color: ProjectColorName = (project.color as ProjectColorName) || 'blue';
	let icon: ProjectIconName = (project.icon as ProjectIconName) || 'folder';
	...
	async function handleSubmit() {
		...
		try {
			...
			// Notify parent
			dispatch('updated', { project: updated });
		} catch (error) {
...
<div class="edit-project-form" data-testid="edit-project-form">
