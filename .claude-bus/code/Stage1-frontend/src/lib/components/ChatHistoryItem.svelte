	...
	<div class="actions">
		...
		{:else}
			...
			>
				<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
					<path
						d="M2 4h12M5.5 4V3a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v1m2 0v9a2 2 0 0 1-2 2h-5a2 2 0 0 1-2-2V4h8z"
						stroke="currentColor"
						stroke-width="1.5"
...
<style>
	 ...
	 *
	 * WHY small, icon-only button:
	 * - Space-efficient: Doesn't crowd sidebar
