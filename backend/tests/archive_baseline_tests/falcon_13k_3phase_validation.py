...
MODEL_NAME = "Falcon-H1_Q5 (13k context)"
...
def phase1_coarse_discovery():
    ...
    output_file = f"backend/tests/falcon_13k_phase1_{timestamp}.json"
...
def phase3_production_validation():
    ...
    print("=" * 80)
    print(f"Validation points: 50, 300, 600, 650 items")
    ...
    # Save results
    timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
    output_file = f"backend/tests/falcon_13k_phase3_{timestamp}.json"
...
def run_full_3phase_validation():
    ...
    print("\n" + "=" * 80)
    print(f"FALCON-H1_Q5 13K CONTEXT - 3-PHASE VALIDATION")
    print("=" * 80)
    print(f"Model: {MODEL_NAME}")
    print(f"Context Window: 13,000 tokens")
