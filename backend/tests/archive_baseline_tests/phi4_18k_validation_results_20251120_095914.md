...
**Model**: phi-4-reasoning-UD-Q8_K_XL (18k context)
**Context Window**: 18,000 tokens (~1000 items)
**Test Date**: 2025-11-20 09:59:14
...
- Safe zone confirmed: 50-1050 items
- 100% accuracy across all positions
- Production-ready with 18k context configuration
